...
model.processvars.addBC(process_variable_name="temperature",geometrical_set="square_1x1_geometry",geometry="center",type="Dirichlet", component="0", parameter="temperature_bc_left")
...
model.writeInput()
print(model.geo.getGeom())
print(model.mesh.getMesh())
#model.runModel()
